                ...
                <div class="accordion" id="accordionExample">
                    <div class="card shadow rounded">
                        <div class="card-header" id="headingOne" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                            <h4 class="mb-0">Quản lí đối tượng</h4>
                        </div>
                        <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                            <div class="card-body  pt-0 pt-md-4">
                                <div class="form-group">
                                    <button id="add-title" type="button" class="btn btn-primary">Thêm đối tượng</button>
                                </div>
                                <div class="table-responsive py-4">
                                    <table class="table table-flush dataTable stripe display compact" id="datatable-basic">
                                        ...
                                        <tr>
                                            <th>ID</th>
                                            <th>Tên đối tượng</th>
                                            <th>Danh sách các danh hiệu liên kết</th>
                                            <th>Ngày tạo</th>
                                            <th>Ngày cập nhật</th>
                                        </tr>
                                        </thead>
    ...
    <script>
        ...
        const table = $('#datatable-basic').DataTable({
            ...
            "language": {
                ...
                "info": "Hiển thị trang thứ _PAGE_ trong _PAGES_ trang (_MAX_ đối tượng)",
            ...
            'processing': true,
            'serverSide': true,
            'ajax': `{!! route('lay-doi-tuong')!!}`,
            'columns': [
                { data: 'id', name: 'id' },
                { data: 'name', name: 'name' },
                { data: 'name_title', name: 'name_title'},
        ...
        $('#datatable-basic').on('click', 'tbody > tr', function () {
            ...
            modal.modal('show');
            $.get(`{{ route('xem-doi-tuong') }}?id=${data.id}`, (response) => {
        ...
        $("#add-title").click(function() {
            ...
            modal.modal();
            modal.modal('show');
            $.get('{{ route('form-them-doi-tuong') }}', (response) => {
                $('#modal-duyet').empty().append(response);
            })
        })
