...
{{--            <img src="{{ asset('argon') }}/img/brand/white.png" style="height: auto;" width="250"/>--}}
        </a>
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="{{ route('home') }}">
                        ...
                        <span class="nav-link-inner--text">{{ __('Bảng điều khiển') }}</span>
                    </a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link nav-link-icon" href="{{ route('profile.edit') }}">
                        ...
                        <span class="nav-link-inner--text">{{ __('Hồ sơ') }}</span>
                    </a>
                </li>
            </ul>
        </div>
